-- Create Quarterly tables using Union: quarter 4: October, November, December 2022
-- Quarter_4_OCT_NOV_DEC.sql
...
-- Select columns from Quarter_4_OCT_NOV_DEC to preview union of tables
...
end_station_name,
member_casual
FROM `final_bike_share_2022.QUARTER_4_OCT_NOV_DEC`
ORDER BY
ride_id DESC

-- Total bike trips in quarter 4: members vs casual riders
...
-- Total bike trips per month in quarter 4: members vs casual riders
...
-- Total bike trips per day in quarter 4: members vs casual riders
...
-- Total bike types in quarter 4: members vs casual riders
...
-- Total bike types per month in quarter 4: members vs casual riders
...
-- Total bike types per day in quarter 4: members vs casual riders
...
-- Mode for bike type in quarter 4: members vs casual riders
...
-- Median for bike types in quarter 4: members vs casual riders
...
-- Max ride length in quarter 4: members vs casual riders
...
-- Min ride length in quarter 4: members vs casual riders
...
order by ride_length asc
 ...
 -- Which days have the highest number of rides in quarter 4: members vs casual riders
...
-- Mode for ride length in quarter 4: members vs casual riders
...
-- Median ride length in quarter 4: members vs casual riders
...
-- Median ride length per day and month in quarter 4: members vs casual riders
...
-- Mean for ride length in quarter 4: members vs casual riders
...
-- Mean for ride length per month in quarter 4: members vs casual riders
...
-- Mean for ride length per day  in quarter 4: members vs casual riders
...
-- Mode for start station in quarter 4: members vs casual riders
...
-- Median for start station in quarter 4: members vs casual riders
...
-- Mean for start station in quarter 4: members vs casual riders
...
-- Mode for end station in quarter 4: members vs casual riders
...
-- Median for end station in quarter 4: members vs casual riders
...
-- Mean for end station in quarter 4: members vs casual riders
...
-- Mode for start time in quarter 4: members vs casual riders
...
-- Median for start time in quarter 4: members vs casual riders
...
-- Mean for start time in quarter 4: members vs casual riders
...
-- Mode for end time in quarter 4: members vs casual riders
...
-- Median for end time in quarter 4: members vs casual riders
...
-- Mean for end time in quarter 4: members vs casual riders 
